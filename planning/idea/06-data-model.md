...
{ "_id": "<caseKey>",
  ...
  "es": { "cover": { "kicker":"...", "headline":"...", "dek":"..." },
          "elCaso":"...", "sigueElDinero":"...", "lasConexiones":"...",
          "cronologia":"...",
          "cierre": { "queSignificaYQueNo":"...", "caveat":"..." },
          "keyFindings": ["..."] },
  "en": { "cover": { "kicker":"...", "headline":"...", "dek":"..." },
  ...
  "scenePlan": {
    ...
    "sigueElDinero": { "sceneId":"MoneyFlowStreams","params":{}, "source":"llm" },
    "lasConexiones": { "sceneId":"ConcentrationFan","params":{}, "source":"llm" },
    "evidencia":     { "sceneId":"EvidenceLedger","params":{}, "source":"fallback" },
    "cronologia":    { "sceneId":"AwardTimeline","params":{}, "source":"llm" },
    "cierre":        { "sceneId":"ClosingStatement","params":{}, "source":"llm" }
  },
  "evidence": [ /* flattened, traceable — drives the Evidencia chapter */ ],
  "audio": { "es": "audio/<caseKey>/3/es.mp3",
             "en": "audio/<caseKey>/3/en.mp3" },
  "podcastCuePoints": { "es": [ { "chapter":"cover","tSec":0 }, ... ],
                        "en": [ ... ] },
